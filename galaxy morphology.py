...
DATA_PATH = "F:/GalaxyProject/galaxy_zoo/"
...
""" Split the dataframe between train and test """
...
ZOOM_FACTOR=1.6
DIMEN=70
FILTERED_DATA_PATH = "F:/GalaxyProject/FilteredData/"
DATASETS_PATH = "F:/GalaxyProject/DataSet/"
...
TEST_DIR = DATASETS_PATH + "testing"
...
test_generator = datagen.flow_from_directory(
    TEST_DIR, class_mode = "sparse", target_size = IMAGE_SIZE, batch_size=BATCH_SIZE
        )

#if path.isdir("F:/Galaxies Project/Dataset1/weights") is False:
#    mkdir("/weights")
...
model_checkpoint = ModelCheckpoint(
    "F:/GalaxyProject/weights/weights.h5", save_weights_only=True, period=5
)
...
z = a.tolist()
b = ["cigar_shaped", "completely_round", "in_between", "on_edge", "spiral", "spiral_barred"]
d=list()
for i in z:
    c = i.index(max(i))
    d.append(b[c])
...
""" MODEL load """
#model = Model.load('FirstModel.h5')
...
# summarize model.
model.summary()
model.load_weights('final_epoch.h5')
